...
export class StraightWithBullnoseComponent implements OnInit {
  ...
  addMeshStairs1() {
    ...
    shape.lineTo(1050, -1439.99);
    shape.lineTo(689.5, -1440);
    shape.lineTo(330.01, -1440);
    shape.lineTo(330, -1049);
    shape.lineTo(496, -1049);
    shape.lineTo(496, -1057.5);
    shape.lineTo(544, -1057.5);
    shape.lineTo(544, -1049);
    shape.lineTo(720, -1049);
    shape.lineTo(720, -19);
  ...
  addMeshStairs2() {
    ...
    shape.moveTo(690.49, -1080.5);
    shape.lineTo(1409.5, -1080.5);
    shape.lineTo(1198.91, -1588.9);
    shape.lineTo(690.51, -1799.5);
    shape.lineTo(690.49, -1080.5);
